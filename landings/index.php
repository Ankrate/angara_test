...
$land_name = array('first' => 'Запчасти на Портер',
					'second' => ' ПОРТЕР 2, Портер 1, HD 65-120'	
					);

$video = array(	'name' => 'Запчасти<br />Портер',
				'price' =>'',
				'video' =>'GengghKwwlQ',
				'cat'  => '',
...
$img1 = array(	'name' => 'Запчасти Портер',
				'price' => '',
				'link' => 'parts/001.png',
				'cat'  => ''
...
$img2 = array(	'name' => 'Запчасти Портер',
				'price' => '',
				'link' => 'parts/001.png',
				'cat'  => ''
				
				 );
$img3 = array(	'name' => 'Запчасти Портер',
				'price' => '',
				'link' => 'parts/001.png',
				'cat'  => ''
				
				 );				 
$img4 = array(	'name' => 'Запчасти Портер',
				'price' => '',
				'link' => 'parts/001.png',
				'cat'  => ''
				
				 );
$title = 'Запчасти на Портер';
				...
				<div class="other-option">
					<div class="block">
						...
						<div class="item">
							...
							<span class="cost"><?=$img1['price']?></span>
							<a href="#dialog" name="modal">купить в 1 клик</a>
						</div>
						<div class="item">
							<h3><?=$img2['name']?></h3>
							...
							<span class="cost"><?=$img2['price']?></span>
							<a href="#dialog" name="modal">купить в 1 клик</a>
						</div>
						<div class="item">
							<h3><?=$img3['name']?></h3>
						...
						<div class="item">
							...
							<span class="cost"><?=$img4['price']?></span>
							<a href="#dialog" name="modal">купить в 1 клик</a>
						</div>
					</div>
				</div>
