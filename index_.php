...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Запчасти для Портер</title>
...
<nav class="navbar navbar-static">
   <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="http://www.bootply.com" target="ext"><b>Ангара</b></a>
...
<header class="masthead">
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <h1><a href="#" title="Scroll down for your viewing pleasure">Ангара запчасти для Портер</a>
          <p class="lead">А так же для HD 72 HD 78</p></h1>
      </div>
      <div class="col-md-6">
        <div class="well pull-right">
          <img src="/img/new/olesya.jpg">        
        </div>
      </div>
    </div>
  </div>
