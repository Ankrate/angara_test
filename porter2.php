...
?>
    <title>Купить запчасти для Хундай Портер 2 купить в Москве дешево</title>
                  ...
                  <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li  class="active" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                                  <a  itemprop="url" ></a><span itemprop="title">Запчасти Портер 2</span>
                             </li>
                        </ul>
                    <h1>Запчасти на Хендай Портер 2</h1>
                    <div class="car-name-mar">
                        <div class="media">
                                              ...
                                              <div class="media-body">
                                                  <a href="porter1/2/">
                                                <h4 class="media-heading media-heading1">Каталог для Портер 2</h4></a>
                                                 </div>
                                            </div>
                                    <?php foreach ($data1 as $cat) { ?>
                                        ...
                                        <div class="media">
                                              <div class="media-left media-middle">
                                                <a href="/category-1-<?=$cat['id']?>-<?=rus2translit($cat['ang_category'])?>-Porter/">
                                        ...
                                        $sub22 = left_side_subcat($cat['id']);
                                         foreach($sub22 as $sub33){
                                             if (check_subcat_emptiness($sub33['id'], 'porter') == 0){
                                                ...
                                                $v = $label[$k];
                                                     ?>
                                             <a href="/subcat-1-<?=$sub33['id']?>-<?=$sub33['parent']?>-<?=rus2translit($sub33['ang_subcat'])?>-Porter/">
