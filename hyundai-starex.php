...
?>
    <title>Купить запчасти для Хундай Старекс в Москве дешево</title>
                  ...
                  <div class="col-md-12">
                        <ul class="breadcrumb">
                            ...
                            <li  class="active" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">
                                  <a  itemprop="url" ></a><span itemprop="title">Запчасти Старекс</span>
                             </li>
                        </ul>
                    <h1>Запчасти для Хендай Старекс</h1>
                                    ...
                                    <?php foreach ($data1 as $cat) { ?>
                                                 ...
                                                 <div class="col-sm-6 col-md-4">
                                                    <div class="thumbnail car-height">
                                                        <a href="/category-3-<?=$cat['id']?>-<?=rus2translit($cat['ang_category'])?>-Starex/">
                                                      <img alt="<?=$cat['ang_category']?>" title="<?=$cat['ang_category']?>" src="/img/categories/<?=$cat['id']?>.jpg">
                                                      </a>
                                                      <div class="caption">
                                         ...
                                         foreach($sub22 as $sub33){
                                             if (check_subcat_emptiness($sub33['id'], 'starex') == 0){
                                                 continue;
                                             }
                                                $k = array_rand($label);
                                                $v = $label[$k];
                                                     ?>
                                             <a href="/subcat-3-<?=$sub33['id']?>-<?=$sub33['parent']?>-<?=rus2translit($sub33['ang_subcat'])?>-Starex/">
