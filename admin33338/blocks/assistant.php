          ...
          <div class="collapse navbar-collapse" id="navbarToggler">
           <a class="navbar-brand" href="/admin33338/">Ангара админка</a>
                    <ul class="nav navbar-nav mr-auto mt-2 mt-lg-0">
                      <li class="dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Инструменты<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a class="dropdown-item"href="/admin33338/calls/calls_insert_detaled.php">Оценка звонков</a></li>
                            <li class="dropdown-divider"></li>
                            <li><a class="dropdown-item"href="/admin33338/calls/calls_report_by_date.php">Помесячный отчет по звонкам</a></li>
                            <li class="dropdown-divider"></li>
                            <li><a class="dropdown-item"href="/admin33338/cat.angarasolaris.com/index.html">Работа с каталогом</a></li>
                        </ul>
                      </li>
