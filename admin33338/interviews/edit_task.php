            ...
            <div class="row">
                <div class="col-md-12">
                    <form name="setup_reminder" action="" method="post">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Название задачи" value="" name="task_name" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Описание" value="" name="task_description"  />
                        ...
                        <input type="hidden" name="people_id" value="<?=$_GET['people_id'] ?>">
                    </form>
                </div>
            </div>
        </div>
