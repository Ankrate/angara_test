...
$data_array = $obj->reorder_get($_GET);
include $_SERVER['DOCUMENT_ROOT'] . '/admin33338/blocks/report_letter.php';
...
if($obj->insert('report',$_GET, $_SESSION['user_id'], $_SESSION['user'] )){
        
    //header ('Location: /admin33338/manager.php');
    $message = 'Отчет без ошибок? Отправить?';
    echo "<SCRIPT type='text/javascript'> //not showing me this
        confirm('$message');
        window.location.replace(\"/admin33338/manager.php\");
    </SCRIPT>";
}else{
