...
?>
    <title>Купить запчасти для Ман автозапчасти для Хендай HD купить в Москве дешево</title>
    <meta name="description" content="Запчасти для Хендай HD интернет магазин в Москве. Всегда 97% запчастей в наличии на складе. ☎ <?=TELEPHONE1?> ">
                                    ...
                                    <?php foreach ($data1 as $cat) { ?>
                                        ...
                                        $sub22 = left_side_subcat($cat['id']);
                                         foreach($sub22 as $sub33){
                                             if (check_subcat_emptiness($sub33['id'], 'hd') == 0){
                                                 continue;
                                             }
                                                $k = array_rand($label);
                                                $v = $label[$k];
