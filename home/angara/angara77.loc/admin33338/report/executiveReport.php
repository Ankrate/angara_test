...
if(isset($_GET['goal'])){
    ...
    $obj->data = $_GET;
    $obj->goal();
    header('Location: /admin33338/report/executiveReport.php');
}   
...
<?php include_once ($_SERVER['DOCUMENT_ROOT'] . '/admin33338/blocks/header.php');?>
        ...
        <div class="container-fluid">
            <?php $obj->table = 'adm_goal';
                 if($_SESSION['user'] == 'admin' && $obj->check_isset() == FALSE):?>
                ...
                <table class="table table-bordered adm-level">
                   <caption class="text-left"> <?= $_SESSION['name']?></caption>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>Приблизился ли я сегодня к цели на один шаг</td>
                            
                            <td><select type="number" class="form-control report input-sm" name="goal"  placeholder="Оценка" value="">
                                <option></option>
                                <option>1</option>
                                <option>0</option>
                            ...
                            <td><button type="submit" class="btn btn-xs btn-success">Save</button></td>
