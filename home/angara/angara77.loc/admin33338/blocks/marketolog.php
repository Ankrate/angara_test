                ...
                <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="/admin33338/reportmarketing/" target="_blank">Ежедневный отчет</a></li>
                            <li class="divider">
                            <?php if(@$_SESSION['type'] == 'marketolog' AND $_SESSION['role'] == 'marketinghead'):?>
                      ...
                      <?php if(@$_SESSION['type'] == 'marketolog' AND $_SESSION['role'] == 'marketinghead'):?>
                     <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Инструменты маркетолога<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a style="" href="/admin33338/linksplan/">Построение ссылок</a></li>
                            <li class="divider"></li>
                            <li><a style="" href="/admin33338/linksplan/linkbuilding_report.php">Отчет по ссылкам</a></li>
                            <li class="divider"></li>
                            <li><a href="/admin33338/calls/">Отчет по звонкам</a></li>
                        </ul>
                      </li>
                     <?php endif?>
