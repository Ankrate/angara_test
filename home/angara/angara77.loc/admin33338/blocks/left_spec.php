...
include("../include/bd.php");
			...
			$result = mysql_query ("SELECT * FROM ang_specials  ORDER BY date_end DESC LIMIT 20");
			if (!$result)
			{
			...
			print '<div id="del_spec1" class="articles_list"><li><a href=editor_spec.php?row='.$myrow[id].'>';
			
			print ($myrow['name']."<br />");
			print "</a></li></div>";
			print "</div>";
			print '<div id="del_spec2" class="table_sell_spec"><a  href=delete_spec.php?delete_spec='.$myrow[id].' onclick="confirm_delete()">x Delete</a></div>';
			print "</div>";
			}
