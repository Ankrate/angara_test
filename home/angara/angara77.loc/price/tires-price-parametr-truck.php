...
?>
      ...
      <?php $data = getKartochkaTiresParametrTruck($_GET['id']);?> 
...
<div class="container">
 ...
 <!--KARTOCHKA TOVARA-->
		...
		<?php if(isset($_GET['action']) AND $_GET['action']=='showall'):?>
  		<?php $data3 = getSameTiresMoreTruck($data[0]);?>
  		<?php else:?>
  		<?php $data3 = getSameTiresTruck($data[0]);?>
  		<?php endif?>
		<!--<?php p($data[0]);?>-->
  ...
  <div class="row">
                            ...
                            <noindex>
                                <div class="alert alert-success ang-alert" role="alert"></div>
                            </noindex>
                            <div class="row">
                                <div class="col-xs-12">
                                    <ul>
                                    	...
                                    	<li>Модель: <strong><a href="/price/tires-price-model-truck.php?id=<?=$data[0]['model_id']?>"><?=$data[0]['model']?></a></strong></li>
                                    	...
                                    	<li>Специальность: <strong><?=$data[0]['typeof_use']?></strong></li>
                                    	<li>Ось: <strong><?=$data[0]['axis_type']?></strong></li>
                               ...
                               <a href="http://angara77.dnobaka.ru/contacts/" class="btn btn-success ang-byu-oneclick "><span></span>Посмотреть контакты</a>
  	...
  	<div class="col-md-4"> 
	                    ...
	                    <div class="col-md-12">
							<div class="tires-text-min">
								...
								<p class="tires-model-text-min">Модель: <a class="tires-model-name" href="/price/tires-price-model-truck.php?id=<?=$v['model_id']?>"><?=$v['model'] ?></a></p>
  ...
  <button><a href="/price/tires-price-parametr-truck.php?id=<?=$_GET['id']?><?php if(isset($_GET['action']) AND $_GET['action']=='showall'):?><?='">'?><?php else:?>&action=showall">Посмотреть все<?php endif?></a></button>
  </div>
  </div>
